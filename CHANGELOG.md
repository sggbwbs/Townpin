# PaikallisCanvas — Changelog

Full, detailed build history for this project. The README covers what's
actually on the site right now and how to set it up; this file is the
chronological record of how it got there, kept for anyone who wants the
full context behind a decision rather than just the current end state.

Entries are in the order they happened, oldest first.
