...
const STRINGS = {
    ...
    askHeroPlaceholder: 'Kysy tekoälyoppaalta',
    askHeroButton: 'Kysy',
    ...
    cyclingTitle: 'Pyöräily Oulussa',
    cyclingSub: 'Oulu tunnetaan yhtenä maailman parhaista pyöräilykaupungeista -- talvipyöräily on täällä arkipäivää, ei poikkeus.',
    cyclingStationsLabel: 'Ilmaiset pyöränhuoltopisteet',
    cyclingStation1: 'Kauppurienkatu, Kauppakeskus Valkean lähellä',
    cyclingStation2: 'Isokadun ja Pakkahuoneenkadun risteys',
    cyclingStation3: 'Kirkkokatu 11',
    cyclingRoutesLabel: 'Suosittuja reittejä',
    cyclingRoute1Name: 'Oulujokisuiston reitti',
    cyclingRoute1Desc: '-- siltoja pitkin suiston saarille, kaunis vesistömaisema',
    cyclingRoute2Name: 'Hietasaaren talviulkoilureitti',
    cyclingRoute2Desc: '-- 8 km, ylläpidetty myös talvella',
    cyclingRoute3Name: 'Iinatti Bike Park, Kaakkuri',
    cyclingRoute3Desc: '-- maasto- ja läskipyöräreittejä, n. 14 km',
    cyclingTestNote: '🧪 Testiversio -- ei vielä lopullinen, tarkka sijaintitieto tulossa myöhemmin.',
    ...
    transitTitle: 'Bussipysäkit lähelläsi',
    transitUseLocation: '📍 Käytä sijaintiani',
    transitEmpty: 'Ei lähtöjä juuri nyt lähistöltä.',
    transitNotConfigured: 'Tulossa pian.',
    transitLoadErr: 'Lähtöjä ei juuri nyt saatu ladattua. Yritä hetken kuluttua uudelleen.',
    transitShowOnMap: 'Näytä kartalla',
    ...
    legalBody: `<p><b>Palvelun tarjoaa:</b> PaikallisCanvas, Y-tunnus 3637817-9.</p>
      ...
      <p><b>Peruuttamisoikeus:</b> vahvistamalla ostoksen yritysostoksi, vahvistat ettei kuluttajansuojalain 14 päivän peruutusoikeus sovellu, ja että näkyvyys alkaa heti. Tilauksen yhteydessä antamasi Y-tunnus tarkistetaan Patentti- ja rekisterihallituksen avoimesta yritysrekisteristä.</p>
      ...
      <p><b>Käsittelemämme tiedot:</b> yrityksesi nimi, Y-tunnus, sähköposti ja verkko-osoite tilauksen toimittamista ja laskutusta varten; osoite (jos annat sen) kartalla näyttämistä varten; IP-osoitteita väärinkäytösten estämiseksi (esim. varauslukot, kirjautumisyritysten ja tekoälyhaun rajoitus, väärinkäytöslokit säilytetään vain muutamia kuukausia). Jos tilaat päivittäisen sähköpostikoonnin, tallennamme sähköpostisi siihen asti kunnes peruutat tilauksen.</p>
      <p><b>Kolmannet osapuolet, jotka voivat käsitellä tietojasi:</b> Stripe (maksut), Supabase (tietokanta), Anthropic (tekoälyvastaukset ja -kuvaukset), Resend (sähköpostien lähetys), Digitransit (linja-autojen aikataulukyselyt, jos käytät "seuraavat lähdöt" -toimintoa), sekä OpenStreetMap Nominatim (osoitteen muuttaminen kartan koordinaateiksi). Sivusto lataa selaimeesi myös Google Fonts -fontteja ja Leaflet-karttakirjaston suoraan niiden ylläpitäjiltä. Emme myy tietojasi eteenpäin.</p>
      <p><b>Evästeet ja selaimen tallennustila:</b> emme käytä seurantaevästeitä. Sivusto tallentaa selaimeesi (ns. localStorage) muun muassa suosikkiyrityksesi, äskettäin katsomasi yritykset, teemavalintasi ja tekoälykeskustelun historian, jotta ne muistetaan seuraavalla käynnilläsi -- nämä pysyvät vain omalla laitteellasi eivätkä lähde meille. Voit tyhjentää ne selaimesi omista asetuksista milloin tahansa.</p>
      <p><b>Oikeutesi:</b> sinulla on oikeus tarkastaa, oikaista ja pyytää poistamaan sinusta tallennetut tiedot, sekä saada ne koneluettavassa muodossa. Ota yhteyttä yllä olevaan sähköpostiin. Jos koet, ettemme käsittele tietojasi asianmukaisesti, voit tehdä valituksen tietosuojavaltuutetun toimistolle (<a href="https://tietosuoja.fi" target="_blank" rel="noopener">tietosuoja.fi</a>).</p>
  ...
  en: {
    ...
    askHeroPlaceholder: 'Ask the AI guide',
    askHeroButton: 'Ask',
    ...
    cyclingTitle: 'Cycling in Oulu',
    cyclingSub: "Oulu is known as one of the best cycling cities in the world -- winter cycling here is everyday life, not the exception.",
    cyclingStationsLabel: 'Free bike repair stations',
    cyclingStation1: 'Kauppurienkatu, near Kauppakeskus Valkea',
    cyclingStation2: 'Isokatu / Pakkahuoneenkatu intersection',
    cyclingStation3: 'Kirkkokatu 11',
    cyclingRoutesLabel: 'Popular routes',
    cyclingRoute1Name: 'Oulujokisuisto river delta route',
    cyclingRoute1Desc: '-- bridges out to the delta islands, beautiful waterside scenery',
    cyclingRoute2Name: 'Hietasaari winter trail',
    cyclingRoute2Desc: '-- 8 km, maintained through winter too',
    cyclingRoute3Name: 'Iinatti Bike Park, Kaakkuri',
    cyclingRoute3Desc: '-- mountain/fatbike trails, approx. 14 km',
    cyclingTestNote: '🧪 Test version -- not final yet, precise location data coming later.',
    ...
    transitTitle: 'Bus stops near you',
    transitUseLocation: '📍 Use my location',
    transitEmpty: 'No departures nearby right now.',
    transitNotConfigured: 'Coming soon.',
    transitLoadErr: "Couldn't load departures right now. Try again in a moment.",
    transitShowOnMap: 'Show on map',
    ...
    legalBody: `<p><b>This service is provided by:</b> PaikallisCanvas, Business ID (Y-tunnus) 3637817-9.</p>
      ...
      <p><b>Right of withdrawal:</b> by confirming this as a business purchase, you confirm the EU consumer 14-day withdrawal right does not apply, and that visibility begins immediately. The business ID you provide at signup is checked against Finland's official open business registry (Finnish Patent and Registration Office).</p>
      ...
      <p><b>Data we process:</b> your company name, business ID, email, and website URL to fulfil and bill your subscription; your address (if you provide one) to show on the map; IP addresses to prevent abuse (e.g. reservation limits, login attempts, and the AI search's rate limit -- abuse-prevention logs are kept for a few months at most). If you subscribe to the daily email digest, we store your email until you unsubscribe.</p>
      <p><b>Third parties who may process your data:</b> Stripe (payments), Supabase (database), Anthropic (AI answers and descriptions), Resend (sending emails), Digitransit (transit timetable queries, if you use the "next departures" feature), and OpenStreetMap Nominatim (converting an address into map coordinates). The site also loads Google Fonts and the Leaflet map library directly from their own providers. We don't sell your data.</p>
      <p><b>Cookies and browser storage:</b> we don't use tracking cookies. The site stores some things directly in your browser (so-called localStorage) -- your favorited businesses, recently viewed businesses, theme choice, and AI chat history -- so they're remembered on your next visit. These stay only on your own device and are never sent to us. You can clear them anytime from your own browser settings.</p>
      <p><b>Your rights:</b> you have the right to access, correct, and request deletion of data we hold about you, and to receive it in a machine-readable format. Contact the email above. If you believe we're not handling your data properly, you can file a complaint with Finland's Data Protection Ombudsman (<a href="https://tietosuoja.fi" target="_blank" rel="noopener">tietosuoja.fi</a>).</p>
