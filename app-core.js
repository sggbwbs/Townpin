...
const STRINGS = {
    ...
    newsAskAiBannerTitle: 'Mietityttääkö jokin uutinen?',
    newsAskAiBannerSub: 'Kysy tekoälyoppaalta lisää paikallisista uutisista ja tapahtumista.',
    ...
    transitTitle: 'Bussilähdöt lähelläsi',
  ...
  en: {
    ...
    newsAskAiBannerTitle: 'Curious about something in the news?',
    newsAskAiBannerSub: 'Ask the AI guide for more on local news and events.',
    ...
    transitTitle: 'Bus departures near you',
